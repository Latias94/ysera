...
impl CommandBufferAllocator {
    ...
    pub fn end_single_use(&self, command_buffer: CommandBuffer) -> Result<(), DeviceError> {
    ...
    fn end_command_buffer(&self, command_buffer: &CommandBuffer) -> Result<(), DeviceError> {
        self.device.end_command_buffer(command_buffer.raw())
    }

    fn reset_command_buffer(&self, command_buffer: &CommandBuffer) -> Result<(), DeviceError> {
        self.device
